...
<body>
	...
	<br>
	<a type="button" class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/teacher/teacherList.jsp">강사 목록으로</a>
	<a type="button" class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/subject/insertSubjectForm.jsp">추가</a>
		<table class="table table-hover">
			...
			%>
					<tr>
						...
						<td>
							<!-- form 안의 for문일때 button / input 걸면 첫번째 정보만뜸 >> a태그 사용할것 230526 -->
							<a type="submit" class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/subject/updateSubjectForm.jsp?subjectNo=<%=s.getSubjectNo()%>">수정</a>
						</td>
						<td>
							<a type="button" class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/subject/deleteSubjectAction.jsp?subjectNo=<%=s.getSubjectNo()%>">삭제</a>
						</td>
					</tr>
			<%
				}
