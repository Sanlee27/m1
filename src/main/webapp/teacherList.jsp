...
<body>
	...
	%>		
			<li>
				<a type="button" class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/teacherList.jsp?currentPage=<%=minPage-rowPerPage%>">이전</a>&nbsp;
			</li>
	<%	
		}
	...
	%>			
				<li>
					<a type="button" class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/teacherList.jsp?currentPage=<%=i%>"><%=i%></a>&nbsp;
				</li>
	<%			
			}
		}
	...
	%>	
			<li>
				<a type="button" class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/teacherList.jsp?currentPage=<%=minPage+rowPerPage%>">다음</a>&nbsp;
			</li>
	<%
		}
	%>
	...
	%>
			<li>
				<a type="button" class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/teacherList.jsp?currentPage=1">마지막페이지</a>&nbsp;
			</li>
	<%
		} else {
	%>	
			<li>
				<a type="button" class="btn btn-outline-secondary" href="<%=request.getContextPath()%>/teacherList.jsp?currentPage=<%=lastPage%>">마지막페이지</a>&nbsp;
			</li>
	<%
		}
	%>		
